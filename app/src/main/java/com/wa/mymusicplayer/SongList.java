...
public class SongList {
    ...
    static class Song_list implements Parcelable {
        ...
        public static final Parcelable.Creator<Song_list> CREATOR = new Parcelable.Creator<Song_list>() {
            @Override
        ...
        static class Billboard implements Serializable {
